...
## Barplots ##
  ...
  row_8_margin_1,row_8_col_1,row_8_margin_2, row_8_col_2, row_8_margin_3 = st.columns((.1,1.5,.7,1.5,.1))  
  with row_8_col_1:
...
## Timelines ##
  ...
  row_10_margin_1,row_10_col_1,row_10_margin_2, row_10_col_2, row_10_margin_3 = st.columns((.1,.5,.6,.5,.1)) 
  with row_10_col_1:
  ...
  row_12_margin_1,row_12_col_1,row_12_margin_2, row_12_col_2, row_12_margin_3 = st.columns((.1,.5,.6,.5,.1)) 
  with row_12_col_1:
